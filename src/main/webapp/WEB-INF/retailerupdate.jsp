<%-- 
    ...
    Created on : Aug. 5, 2024, 4:38:21 p.m.
    Author     : yuvra
--%>
   ...
   <head>
    ...
    <body>
        ...
        <% Item item = (Item)request.getAttribute("item"); %>
                ...
                <input type="text"  name="exp_date" readonly="true" value="<%=inventory.getExpiryDateWidgetFmt()%>"><br>
                <label for="price">Discounted Price</label><br>
                <input type="text"  name="price" value="<%=inventory.getDiscountedPrice()%>"><br>
                <label for="quantity">Quantity</label><br>
                <input type="number"  name="quantity" value="<%=inventory.getQuantity()%>"><br>
                <label for="surplus">Surplus</label><br>
                <input type="checkbox"  name="surplus" value="<%=inventory.IsSurplus()%>"><br>
